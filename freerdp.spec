...
for f in winpr-hash winpr-makecert wlfreerdp xfreerdp; do
    mv %{buildroot}%{_mandir}/man1/$f.1 %{buildroot}%{_mandir}/man1/${f}3.1
done
...
* Fri Jan 19 2024 Nicholas Kudriavtsev <nkudriavtsev@gmail.com> - 3:3.2.0-1
- Update to 3.2.0

* Fri Dec 22 2023 Nicholas Kudriavtsev <nkudriavtsev@gmail.com> - 3:3.1.0-1
- Update to 3.1.0
